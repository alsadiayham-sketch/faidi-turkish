...
window.seedFirestoreData = function(clearExisting) {
    ...
    var products = [
        ...
        { name: 'فستان ميدي منقوش', brand: 'Trendyol', category: 'فساتين', image: 'https://i.ibb.co/rfZGdmgw/9b3c26149629.gif', description: 'فستان ميدي بنقشات تركية عصرية يناسب إطلالات النهار.', status: '', sizes: clothingSizes(175) },
        ...
        { name: 'ليقنز رياضي مطاطي', brand: 'LC Waikiki', category: 'سبورات', image: 'https://i.ibb.co/fzhjH65w/a4ba0eb5fdf7.gif', description: 'ليقنز رياضي عالي الخصر بخامة مطاطية داعمة.', status: '', sizes: clothingSizes(90) },
        ...
        // ===== إكسسوارات =====
        { name: 'شنطة يد تركية', brand: 'Boyner', category: 'إكسسوارات', image: 'https://i.ibb.co/RpvfwhnD/3aaf2d1f3a69.gif', description: 'شنطة يد أنيقة بتصميم تركي عملي وفاخر.', status: 'special', sizes: oneSize(90) },
