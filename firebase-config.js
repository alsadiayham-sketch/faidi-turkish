// faidi-turkish data layer — talks to the secure Cloudflare D1 backend at /api/*.
...
(function (global) {
    var API = '/api';
    var TOKEN_KEY = 'faidi_token';
    var USER_KEY = 'faidi_user';
    ...
    global.db = db;
    global.faidiAuth = faidiAuth;
    global.PROJECT_ID = 'faidi-turkish';
})(window);
